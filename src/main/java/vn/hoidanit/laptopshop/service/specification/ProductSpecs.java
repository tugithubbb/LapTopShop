...
public class ProductSpecs {
    ...
    public static Specification<Product> priceMin(double price) {
        return (root, query, criteriaBuilder) -> criteriaBuilder.ge(root.get(Product_.PRICE), price);
    }

    public static Specification<Product> priceMax(double price) {
    ...
    public static Specification<Product> matchFactorys(List<String> factory) {
